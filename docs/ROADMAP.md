...
| **17** | [Storage location in an overflow menu](phases/phase-17-storage-location-menu.md) | A `…` menu in the bar that opens the data directory in the file manager, and holds the appearance override, the window frame, and About | 0, 6 | Done |
...
| **27** | [Always-visible tracking reminder](phases/phase-27-always-visible-tracking-reminder.md) | Discovery of a persistent reminder that can make forgotten tracking less likely without becoming distracting | 2, 6, 8 | In progress |
